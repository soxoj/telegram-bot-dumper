...
# Optional live hooks for embedding (webapp streams these). None under CLI usage.
ON_MESSAGE = None  # callable(chat_id: str, line: str) -- line is the same text written to history
ON_USER = None     # callable(user_dict: dict) -- after profile json + photos are saved
